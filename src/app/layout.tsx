...
export const metadata: Metadata = {
  title: "LuxeStay - Luxury Hotel Accommodations & Fine Dining",
  description: "Experience world-class luxury at LuxeStay. Book your stay with premium rooms, spa, pool, and fine dining in an unforgettable five-star hotel environment.",
  keywords: "luxury hotel, accommodation, five-star hotel, resort, fine dining, spa, pool",
  openGraph: {
    title: "LuxeStay - Luxury Hotel Accommodations",
    description: "Experience unparalleled luxury and comfort at LuxeStay five-star hotel.",
    siteName: "LuxeStay",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763816365857-ltv15m92.jpg",
  ...
  twitter: {
    ...
    title: "LuxeStay - Five-Star Hotel Luxury",
    description: "Book your luxury stay at LuxeStay with world-class amenities and service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763816365857-ltv15m92.jpg"]
  },
  robots: {
    index: true,
    follow: true
